    ...
    async createAvrora(file, body) {
        ...
        async function createGoods(obj) {
            // const good = await GoodModel.findOne({where: { guid: obj.guid }})
                console.log(obj)
                const sql = `INSERT INTO goods(title, group_id, guid, createdAt, updatedAt) VALUES('${obj.title}', '${obj.group_id}', '${obj.guid},DATE  '2001-01-01',DATE  '2001-01-01') ON DUPLICATE KEY UPDATE title='${obj.title}'`;
